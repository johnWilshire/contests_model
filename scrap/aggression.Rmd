...
levelplot(get_level_plotable(1), margin=FALSE, xlab = "K", ylab = "E_0", main = "Aggression", at = my_at, colorkey = my_ckey, par.settings=my_theme)
...
```{R}
levelplot(get_level_plotable(0.5), margin=FALSE, xlab = "K", ylab = "E_0", main = "Aggression", at = my_at, colorkey = my_ckey, par.settings=my_theme)
```

close to 0 energy (e_current = 0.1)
```{R}

levelplot(get_level_plotable(0.1), margin=FALSE, xlab = "K", ylab = "E_0", main = "Aggression", at = my_at, colorkey = my_ckey, par.settings=my_theme)
