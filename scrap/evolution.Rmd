...
population_plots <- function (what){
  print(pop_values(expf10_pop, what, paste("expf10_pop", what)))
  print(pop_values(expf15_pop, what, paste("expf15_pop", what)))
  print(pop_values(linf10_pop, what, paste("linf10_pop", what)))
}

population_plots("e_0")
population_plots("k")
population_plots("2 * radius * speed")
