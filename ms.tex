...
% ie pulling the maturation times from the logistic cdf with location and parameters given
...
\begin{figure}[h!]
    ...
    \caption{a line(ish) plot of the aggression parameter $k$ at max energy}
    \label{fig:k history}

    \includegraphics[width=10cm,height=10cm,keepaspectratio]{figures/e_0_history.pdf}
    \caption{a line(ish) plot of the aggression parameter $e_0$  k at max energy}
