...
\begin{equation} \label{eq:searching}
    \frac{dS}{dt} = aS -bS^2 - \frac{cS}{1+O} - eS - gO + fO
\end{equation}
Occupying individuals
\begin{equation} \label{eq:occupying}
    \frac{dO}{dt} = \frac{cS}{1+O} - eO - fO
\end{equation}

$aS - bS^2$ is individuals becoming mature.\\
$\frac{cS}{1+O}$ is searching individuals becoming occupiers through finding nests that are unoccuied.\\
$e$ is metabolic death rate\\
$f$ is the abandon rate\\
$g$ is the rate at which occupiers die in a contest\\
