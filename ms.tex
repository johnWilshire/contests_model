...
% ie pullign the maturation times from the logistic cdf with location and parameters given
...
We assume that there are energetic costs, but that there is no time cost to contests ie they occur instantanously.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=15cm,height=10cm,keepaspectratio]{figures/energy_pc_plot.pdf}
    \caption{Percent energy expediture of cohort at generation 499}
    \label{fig:energy_pc}
\end{figure}

As patch area increases the number of fight oppurtunities decreases, 
This can probably explain the strong decrease in energy spent fighting. but I have no idea, early days yet.

\begin{figure}[h!]
    \centering
    \includegraphics[width=15cm,height=12cm,keepaspectratio]{figures/energy_total_plot.pdf}
    \caption{Total energy expeniture of cohort at generation 499}
    \label{fig:energy_total}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=15cm,height=10cm,keepaspectratio]{figures/aggression_density.pdf}
    \caption{Number of successful males at different patch areas, gaps are because it took longer than 12 hours to run}
    \label{fig:num_winners}
\end{figure}
