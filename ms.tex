...
\begin{figure}[h!]
    \centering
    \includegraphics[width=10cm,height=9cm,keepaspectratio]{#1}
    \caption{#2}
    \centering
    \includegraphics[width=10cm,height=9cm,keepaspectratio]{#3}
    \caption{#4}
\end{figure}
}
...
\myfigure{figures/energy_pc_plot_cm_100.pdf}{pc energy spent on what}{figures/energy_total_plot_cm_100.pdf}{total energy spent on what}

\myfigure{figures/e_0_nest_density.pdf}{e 0 with patch area}{figures/k_patch_area.pdf}{k with patch area}

\myfigure{figures/e_0_nest_density.pdf}{e 0 with nest density}{figures/k_patch_area.pdf}{k with nest density}

\begin{figure}[h!]
    \centering
    \includegraphics[width=15cm,height=10cm,keepaspectratio]{figures/cm_100_num_winners.pdf}
    \caption{Number of successful males at different patch areas}
\end{figure}
